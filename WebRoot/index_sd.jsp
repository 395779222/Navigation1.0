...
<body  bgColor="transparent" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" onLoad="onload();" scroll="no" >
    <div style="position:absolute; left:0px; top:0px; width:720px; height:576px;"><img src="<%=request.getContextPath()%>/images/sdsy/sd.jpg" width="720" height="576"  /></div>
	  <!--通知链接-->
 	<div style="position:absolute; top:125px; left:650px;display:none" ><img src="<%=request.getContextPath()%>/images/gdsy/0608/images/img02.png" id="dv-right" onclick="test()"></div>
<!-- 	<div style="position:absolute; left:0px; top:0px; width:720px; height:576px;" ><img src="<%=request.getContextPath()%>/${adIcon}" ></div> -->
