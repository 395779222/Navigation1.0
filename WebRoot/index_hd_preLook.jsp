 	...
 	function onload(){
 		...
 		for(var i =0;i<imgList.length;i++){
 			if(imgList[i].getAttribute("name")=="我的空间"){
 				alert(infoboxURL(imgList[i].parentNode.getAttribute("href") ));
...
<body  bgColor="transparent" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" onLoad="onload();" scroll="no" >
    ...
    <div style="position:absolute; left:0px; top:0px; width:1280px; height:720px;"><img src="<%=request.getContextPath()%>/images/gdsy/0608/images/home.jpg" width="1280" height="720" />
    </div>
	<!--通知链接-->
	...
	<div style="position:absolute; top:591px; left:484px; width: 118px; height: 25px; text-align:center;" class="font_24" >第<span id="pageNum"></span>/${maxNum}页<br></div>
   	...
   	<div style="position:absolute; left:500px; top:70px;">
		预览页面按此处翻页：<input type="button" value="上一页" onclick="doPageUp()" > <input type="button" value="下一页" onclick="doPageDown()">
	</div>
  </body>
</html>
